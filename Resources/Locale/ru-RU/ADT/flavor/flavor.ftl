...
flavor-interface-headshot-url-desc = "Вставьте прямую ссылку на изображение (должна заканчиваться на .jpg, .png или .webp). Рекомендуемый размер: 300x300. Макс. вес: 5 МБ."
