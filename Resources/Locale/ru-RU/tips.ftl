...
tips-dataset-14 = Не забывайте хоть иногда выходить на улицу потрогать траву в перерывах между раундами Freaky Station 14.
...
tips-dataset-17 = Другие игроки — тоже фрики.
