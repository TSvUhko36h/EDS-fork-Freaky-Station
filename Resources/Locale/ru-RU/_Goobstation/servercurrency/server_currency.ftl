...
gs-balanceui-shop-buy-token-antag = Купить токен антага - { $price } Фрики Коинов
...
gs-balanceui-roulette-invalid-bet = Введите корректную ставку (целое число больше 0).
gs-balanceui-roulette-result-lose = Рулетка: x{ $multiplier }. Вы проиграли { $bet }.
